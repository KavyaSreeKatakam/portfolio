...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Kavya Sree Katakam.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">3 years</span> of experience. I enjoy
        building <span className="italic">web applications and web services</span> using technologies like
        <span className="underline"> Typescript, Java, React, Mysql and many more </span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60 dark:hover:bg-white/30"
          href="https://www.linkedin.com/in/kavyakatakam09/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60 dark:hover:bg-white/30"
          href="https://github.com/KavyaSreeKatakam"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
